...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ToDo_RAY",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8ToDo_RAY22AddTableViewController")
...
@property (nonatomic, weak) IBOutlet UIBarButtonItem * _Null_unspecified cancelBarButton;
...
@interface AddTableViewController (SWIFT_EXTENSION(ToDo_RAY)) <UITextFieldDelegate>
...
SWIFT_CLASS("_TtC8ToDo_RAY11AppDelegate")
...
SWIFT_CLASS("_TtC8ToDo_RAY23ChecklistViewController")
